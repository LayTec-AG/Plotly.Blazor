...
public class TestClass : TestClassAbstract, ITestClass
{
    ...
    [JsonPropertyName(@"testProperty2")] public override string TestProperty2 { get; set; }

    [JsonPropertyName(@"testProperty")] public string TestProperty { get; set; }
}
...
public class TestSubplotClass : ITestClass
{
    ...
    [JsonPropertyName("testProperty2")] public string TestProperty2 { get; set; }

    [JsonPropertyName("testProperty2")]
    [Array]
    public IList<string> TestProperty2Array { get; init; }

    [JsonPropertyName("testProperty3")] public string TestProperty3 { get; set; }

    [JsonPropertyName("testProperty3")]
    [Array]
    public IList<string> TestProperty3Array { get; set; } = [];

    [JsonPropertyName("testProperty4")] public string TestProperty4 { get; set; }

    [JsonPropertyName("testProperty4")]
    [Array]
    public IList<object> TestProperty4Array { get; init; }

    [Subplot] public IList<TestClass> Items { get; set; }

    // ensure that the regex does not match "items"
    [JsonPropertyName("notItems")] public string NotItems { get; set; }
...
{
    [EnumMember(Value = "default")] Enum1,
    [EnumMember(Value = "notDefault")] Enum2,
...
{
    [EnumMember(Value = "skip")] Skip = 0,
    [EnumMember(Value = "none")] None = 1,
    [EnumMember(Value = "enum1")] EnumOne = 2,
    [EnumMember(Value = "enum2")] EnumTwo = 4,
    [EnumMember(Value = "enum3")] EnumThree = 8,
    [EnumMember(Value = "false")] False = 16,
    [EnumMember(Value = "all")] All = EnumOne | EnumTwo | EnumThree | False
}

internal class ClassToTestObjectDeserialization
{
...
public class ConverterTests
{
    ...
    public void PolymorphicConverterTest()
    {
        ...
        {
            InterfaceProperty = new TestClass
                { TestProperty = "TestInterfaceProperty", TestProperty2 = "TestAbstractProperty" },
            AbstractProperty = new TestClass
                { TestProperty = "TestInterfaceProperty", TestProperty2 = "TestAbstractProperty" }
        };
    ...
    {
        ClassicAssert.AreEqual("\"2020-05-31\"",
            JsonSerializer.Serialize(new DateTime(2020, 5, 31), serializerOptions));
        ClassicAssert.AreEqual("\"2020-05-31 12:00:00\"",
            JsonSerializer.Serialize(new DateTime(2020, 5, 31, 12, 0, 0), serializerOptions));
    }
    ...
    {
        ClassicAssert.AreEqual("\"2020-05-31\"",
            JsonSerializer.Serialize(new DateTimeOffset(new(2020, 5, 31)), serializerOptions));
        ClassicAssert.AreEqual("\"2020-05-31 12:00:00\"",
            JsonSerializer.Serialize(new DateTimeOffset(new(2020, 5, 31, 12, 0, 0)), serializerOptions));
    }
    ...
    [TestCase("{\"ParameterA\":1.23456,\"ParameterB\":[1.23,4.56,null,7]}", 1.23456,
        new object[] { 1.23, 4.56, null, 7 })]
    [TestCase("{\"ParameterA\":true,\"ParameterB\":[true,false,null,true]}", true,
        new object[] { true, false, null, true })]
    [TestCase("{\"ParameterA\":\"abc\",\"ParameterB\":[\"abc\",\"def\",null,\"ghi\"]}", "abc",
        new object[] { "abc", "def", null, "ghi" })]
    ...
    public void ShouldDeserializeComplexTypesToDictionary()
    {
        ...
        var json =
            "{\"ParameterA\":{\"PropertyA\":\"abc\",\"PropertyB\":true},\"ParameterB\":[{\"PropertyA\":\"def\",\"PropertyB\":2},{\"PropertyA\":\"ghi\",\"PropertyB\":1.23}]}";
    ...
    public void ShouldRoundTripLists()
    {
        ...
        var json =
            "{\"ParameterA\":{\"PropertyA\":\"abc\",\"PropertyB\":true},\"ParameterB\":[{\"PropertyA\":\"def\",\"PropertyB\":2},null,1.23,\"abc\",true]}";
