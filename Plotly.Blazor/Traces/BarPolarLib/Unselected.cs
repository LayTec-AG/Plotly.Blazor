...
namespace Plotly.Blazor.Traces.BarPolarLib
{
    ...
    public class Unselected : IEquatable<Unselected>
    {
        ...
        public Plotly.Blazor.Traces.BarPolarLib.UnselectedLib.Marker Marker { get; set;} 

        /// <summary>
        ///     Gets or sets the TextFont.
        /// </summary>
        [JsonPropertyName(@"textfont")]
        public Plotly.Blazor.Traces.BarPolarLib.UnselectedLib.TextFont TextFont { get; set;} 
