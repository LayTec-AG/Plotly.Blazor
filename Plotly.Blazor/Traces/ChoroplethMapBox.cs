...
using Plotly.Blazor.Traces.ChoroplethMapBoxLib;
...
namespace Plotly.Blazor.Traces
{
    ...
    public class ChoroplethMapBox : ITrace
    {
        ...
        /// <summary>
        ///     Sets which features found in *geojson* to plot using their feature `id`
        ///     field.
        /// </summary>
        ...
        ///     type *FeatureCollection* or *Feature* with geometries of type *Polygon*
        ///     or *MultiPolygon*.
        /// </summary>
        ...
        ///     included in the `locations` array. Support nested property, for example
        ///     *properties.name*.
        /// </summary>
        ...
        ///     the water layers. If set to '', the layer will be inserted above every existing
        ///     layer.
        /// </summary>
        ...
        ///     that are `arrayOk: true`) are available. variable `properties` Anything
