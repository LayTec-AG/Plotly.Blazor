...
{
    /// <summary>
    ///     The DensityMap class.
    ///     Implements the <see cref="ITrace" />.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("Plotly.Blazor.Generator", null)]
    [JsonConverter(typeof(PlotlyConverter))]
    [Serializable]
    public class DensityMap : ITrace, IEquatable<DensityMap>
    {
        /// <inheritdoc/>
        [JsonPropertyName(@"type")]
        public TraceTypeEnum? Type { get; } = TraceTypeEnum.DensityMap;
        ...
        /// <summary>
        ///     Determines if the densitymap trace will be inserted before the layer with
        ///     the specified ID. By default, densitymap traces are placed below the first
        ///     layer of type symbol If set to &#39;&#39;, the layer will be inserted above
        ...
        public Plotly.Blazor.Traces.DensityMapLib.ColorBar ColorBar { get; set;} 
        ...
        public Plotly.Blazor.Traces.DensityMapLib.HoverInfoFlag? HoverInfo { get; set;} 
        ...
        [JsonPropertyName(@"hoverinfo")]
        [Array]
        public IList<Plotly.Blazor.Traces.DensityMapLib.HoverInfoFlag?> HoverInfoArray { get; set;} 
        ...
        public Plotly.Blazor.Traces.DensityMapLib.HoverLabel HoverLabel { get; set;} 
        ...
        public Plotly.Blazor.Traces.DensityMapLib.LegendGroupTitle LegendGroupTitle { get; set;} 
        ...
        public Plotly.Blazor.Traces.DensityMapLib.Stream Stream { get; set;} 
        ...
        public Plotly.Blazor.Traces.DensityMapLib.VisibleEnum? Visible { get; set;} 
        ...
        {
            if (!(obj is DensityMap other)) return false;

            return ReferenceEquals(this, obj) || Equals(other);
        }

        /// <inheritdoc />
        public bool Equals([AllowNull] DensityMap other)
        {
        ...
        /// <summary>
        ///     Checks for equality of the left DensityMap and the right DensityMap.
        /// </summary>
        /// <param name="left">Left DensityMap.</param>
        /// <param name="right">Right DensityMap.</param>
        /// <returns>Boolean</returns>
        public static bool operator == (DensityMap left, DensityMap right)
        {
            return Equals(left, right);
        }

        /// <summary>
        ///     Checks for inequality of the left DensityMap and the right DensityMap.
        /// </summary>
        /// <param name="left">Left DensityMap.</param>
        /// <param name="right">Right DensityMap.</param>
        /// <returns>Boolean</returns>
        ...
        /// </summary>
        /// <returns>DensityMap</returns>
        public DensityMap DeepClone()
        {
            return this.Copy();
        }
    }
