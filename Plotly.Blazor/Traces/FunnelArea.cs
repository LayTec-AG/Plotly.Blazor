...
namespace Plotly.Blazor.Traces
{
    ...
    public class FunnelArea : ITrace, IEquatable<FunnelArea>
    {
        ...
        ///     has access to variables <c>label</c>, <c>color</c>, <c>value</c>, <c>text</c>
        ///     and <c>percent</c>. Anything contained in tag <c>&lt;extra&gt;</c> is displayed
