...
namespace Plotly.Blazor.Traces
{
    ...
    public class Mesh3D : ITrace
    {
        ...
        ///     `y` and `z` jointly represent the X, Y and Z coordinates of the nth vertex.
        /// </summary>
        [JsonPropertyName(@"x")]
        ...
        ///     of the vertex vectors, representing the *first* vertex of a triangle. For
        ///     example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in
        ///     the mesh, where `i[m] = n` points to the triplet `{x[n], y[n], z[n]}` in
        ///     the vertex arrays. Therefore, each element in `i` represents a point in
        ///     space, which is the first vertex of a triangle.
        /// </summary>
        [JsonPropertyName(@"i")]
        public IList<object> I { get; set;} 

        /// <summary>
        ///     A vector of vertex indices, i.e. integer values between 0 and the length
        ///     of the vertex vectors, representing the *second* vertex of a triangle. For
        ///     example, `{i[m], j[m], k[m]}`  together represent face m (triangle m) in
        ///     the mesh, where `j[m] = n` points to the triplet `{x[n], y[n], z[n]}` in
        ///     the vertex arrays. Therefore, each element in `j` represents a point in
        ...
        /// <summary>
        ///     A vector of vertex indices, i.e. integer values between 0 and the length
        ///     of the vertex vectors, representing the *third* vertex of a triangle. For
        ///     example, `{i[m], j[m], k[m]}` together represent face m (triangle m) in
        ///     the mesh, where `k[m] = n` points to the triplet  `{x[n], y[n], z[n]}` in
        ///     the vertex arrays. Therefore, each element in `k` represents a point in
        ...
        ///     (points) represented by the `x`, `y` and `z` arrays, if the `i`, `j`, `k`
        ///     arrays are not supplied. For general use of `mesh3d` it is preferred that
        ///     `i`, `j`, `k` are supplied. If *-1*, Delaunay triangulation is used, which
        ///     is mainly suitable if the mesh is a single, more or less layer surface that
        ///     is perpendicular to `delaunayaxis`. In case the `delaunayaxis` intersects
        ///     the mesh surface at more than one point it will result triangles that are
        ///     very long in the dimension of `delaunayaxis`. If *>0*, the alpha-shape algorithm
        ///     is used. In this case, the positive `alphahull` value signals the use of
        ///     the alpha-shape algorithm, _and_ its value acts as the parameter for the
        ///     mesh fitting. If *0*,  the convex-hull algorithm is used. It is suitable
        ///     for convex bodies or if the intention is to enclose the `x`, `y` and `z`
        ///     point set into a convex hull.
        /// </summary>
        [JsonPropertyName(@"alphahull")]
        public float? AlphaHull { get; set;} 
        ...
        public IList<object> Intensity { get; set;} 
        ...
        /// <summary>
        ///     Sets the color of each vertex Overrides *color*. While Red, green and blue
        ///     colors are in the range of 0 and 255; in the case of having vertex color
        ///     data in RGBA format, the alpha color should be normalized to be between
        ///     0 and 1.
        /// </summary>
        ...
        ///     input data (here `intensity`) or the bounds set in `cmin` and `cmax`  Defaults
        ...
        ///     as `intensity` and if set, `cmax` must be set as well.
        /// </summary>
        ...
        ///     as `intensity` and if set, `cmin` must be set as well.
        /// </summary>
        ...
        ///     be equidistant to this point. Value should have the same units as `intensity`.
