...
namespace Plotly.Blazor.Traces.ScatterGlLib
{
    ...
    public class Unselected : IEquatable<Unselected>
    {
        ...
        public Plotly.Blazor.Traces.ScatterGlLib.UnselectedLib.Marker Marker { get; set;} 

        /// <summary>
        ///     Gets or sets the TextFont.
        /// </summary>
        [JsonPropertyName(@"textfont")]
        public Plotly.Blazor.Traces.ScatterGlLib.UnselectedLib.TextFont TextFont { get; set;} 
