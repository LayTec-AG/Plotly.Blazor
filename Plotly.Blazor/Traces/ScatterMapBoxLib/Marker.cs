...
using Plotly.Blazor.Traces.ScatterMapBoxLib.MarkerLib;
...
namespace Plotly.Blazor.Traces.ScatterMapBoxLib
{
    ...
    public class Marker 
    {
        ...
        ///     that the array `marker.color` and `marker.size` are only available for *circle*
        ///     symbols.
        /// </summary>
        ...
        ///     using the *auto* default, no rotation would be applied in perspective views
        ///     which is different from using a zero angle.
        /// </summary>
