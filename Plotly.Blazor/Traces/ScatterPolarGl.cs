...
using Plotly.Blazor.Traces.ScatterPolarGlLib;
...
namespace Plotly.Blazor.Traces
{
    ...
    public class ScatterPolarGl : ITrace
    {
        ...
        /// <summary>
        ///     Alternate to `theta`. Builds a linear space of theta coordinates. Use with
        ///     `dtheta` where `theta0` is the starting coordinate and `dtheta` the step.
        /// </summary>
        [JsonPropertyName(@"theta0")]
        public object Theta0 { get; set;} 

        /// <summary>
        ///     Sets the theta coordinate step. By default, the `dtheta` step equals the
        ///     subplot's period divided by the length of the `r` coordinates.
        /// </summary>
        ...
        ///     If *polar* (the default value), the data refer to `layout.polar`. If *polar2*,
        ///     the data refer to `layout.polar2`, and so on.
        /// </summary>
