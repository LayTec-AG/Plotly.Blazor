...
namespace Plotly.Blazor.Traces.ScatterSmithLib
{
    ...
    public class Selected : IEquatable<Selected>
    {
        ...
        public Plotly.Blazor.Traces.ScatterSmithLib.SelectedLib.Marker Marker { get; set;} 

        /// <summary>
        ///     Gets or sets the TextFont.
        /// </summary>
        [JsonPropertyName(@"textfont")]
        public Plotly.Blazor.Traces.ScatterSmithLib.SelectedLib.TextFont TextFont { get; set;} 
