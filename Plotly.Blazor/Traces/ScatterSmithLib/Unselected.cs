...
namespace Plotly.Blazor.Traces.ScatterSmithLib
{
    ...
    public class Unselected : IEquatable<Unselected>
    {
        ...
        public Plotly.Blazor.Traces.ScatterSmithLib.UnselectedLib.Marker Marker { get; set;} 

        /// <summary>
        ///     Gets or sets the TextFont.
        /// </summary>
        [JsonPropertyName(@"textfont")]
        public Plotly.Blazor.Traces.ScatterSmithLib.UnselectedLib.TextFont TextFont { get; set;} 
