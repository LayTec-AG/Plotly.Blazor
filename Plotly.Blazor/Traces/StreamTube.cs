...
namespace Plotly.Blazor.Traces
{
    ...
    public class StreamTube : ITrace
    {
        ...
        /// <summary>
        ///     Sets a text element associated with this trace. If trace `hoverinfo` contains
        ///     a *text* flag, this text element will be seen in all hover labels. Note
        ///     that streamtube traces do not support array `text` values.
        /// </summary>
        ...
        ///     that are `arrayOk: true`) are available. variables `tubex`, `tubey`, `tubez`,
        ///     `tubeu`, `tubev`, `tubew`, `norm` and `divergence`. Anything contained in
        ///     tag `<extra>` is displayed in the secondary box, for example "<extra>{fullData.name}</extra>".
