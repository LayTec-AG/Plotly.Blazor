...
using Plotly.Blazor.Traces.SurfaceLib;
...
namespace Plotly.Blazor.Traces
{
    ...
    public class Surface : ITrace
    {
        ...
        /// <summary>
        ///     Sets the text elements associated with each z value. If trace `hoverinfo`
        ...
        ///     input data (here z or surfacecolor) or the bounds set in `cmin` and `cmax`
        ...
        ///     as z or surfacecolor and if set, `cmax` must be set as well.
        /// </summary>
        ...
        ///     as z or surfacecolor and if set, `cmin` must be set as well.
        /// </summary>
        ...
        ///     be equidistant to this point. Value should have the same units as z or surfacecolor.
        ...
        ///     to *false* `contours.x.show` to *true* and `contours.y.show` to *true* to
        ///     draw a wire frame plot.
        /// </summary>
