...
namespace Plotly.Blazor.Traces
{
    ...
    public class Waterfall : ITrace
    {
        ...
        ///     as 'relative'. However; it is possible to use 'total' to compute the sums.
        ///     Also 'absolute' could be applied to reset the computed total or to declare
        ///     an initial value where needed.
        /// </summary>
        ...
        ///     that are `arrayOk: true`) are available. variables `initial`, `delta` and
        ///     `final`. Anything contained in tag `<extra>` is displayed in the secondary
        ///     box, for example "<extra>{fullData.name}</extra>". To hide the secondary
