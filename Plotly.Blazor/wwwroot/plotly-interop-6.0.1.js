...
export function update(id, dataUpdate, layoutUpdate, indices) {
    onPlotlyReady(id, () => {
        ...
        if (indices == null) {
            window.Plotly.update(id, dataUpdate, layoutUpdate);
        } else {
            window.Plotly.update(id, dataUpdate, layoutUpdate, indices);
        }
    });
}
